...
`BiPlotteR` is based on the `Plotly` interactive graphical interface and allows you to create captivating 2D and 3D biplots after performing the Principal Component Analysis using the `prcomp` function provided by the `stats` R package.
