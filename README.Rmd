...
Here you can explore the interactive output of the `Biplot 3D`. As shown by the following code line, the ouput refers to the Principal Component Analysis performed on the Iris_4BPLTR input dataset.
...
Here you can see an example of an interactive screeplot generated by the `ScreePlot` function. 
